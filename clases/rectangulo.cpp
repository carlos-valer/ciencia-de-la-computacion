...
//Rectangulo::Rectangulo( Point &p1, Point &p3){
//	Poligono(update_Constructor(p1,Point(p1.getX(),p3.getY()),p3,Point(p3.getX() ,p1.getY())),4);
//	
//}
...
Rectangulo::Rectangulo(int x1, int y1, int x3, int y3) : Poligono(update_Constructor(Point(x1,y1),
																					 Point(x1,y3),
																					 Point(x3,y3),
																					 Point(x3,y1)
																					 )
